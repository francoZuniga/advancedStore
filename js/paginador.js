//creamos el algoritmo de la paginacion
 var pagina = document.getElementById("indicador").value;//la pagina Actual
 var total = document.getElementById("total").value;//la cantidad de paginas totales
...
if (pagina == 1) {
	...
	for (var i = pagina + 3; i <= total; i++) {
		...
		document.getElementById(pagina).setAttribute("style", "background-color: #e1381c; color: #fff;");
