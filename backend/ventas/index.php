  ...
  <body>
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav mr-auto border-primary justify-content-center">
	        ...
	        <li class="nav-item">
	          ...
	          <a class="nav-link" href="#"><img src="" alt="">Ventas</a>
	        </li>
		...
		<section>
			<?php
			 ...
			 ?>
			 <a class="btn" class="btn bg-transparent" href="registrarVentas.php"><img src="../../Media/outline_add_circle_outline_black_18dp.png" style="width: 50px;"></a>
			<nav>
			  <div class="nav nav-tabs" id="nav-tab" role="tablist">
			    ...
			    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">devolucion</a>
			  </div>
			</nav>
