  ...
  <body>
    <a href="index.php"><img src="../../Media/outline_undo_black_18dp.png"></a>
		<section class="container form-group">
				...
				<form action="compra.php" style="width: 50%;" method="post" class="">
					Productos
					...
					<a href="cargarPdf.php" class="btn btn-outline-success btn-lg" role="button" style="float: right;">registrar</a>
